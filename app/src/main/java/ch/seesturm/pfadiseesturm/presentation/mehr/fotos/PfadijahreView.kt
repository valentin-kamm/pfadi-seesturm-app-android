                ...
                when (val localState = uiState) {
                    UiState.Loading -> {
                        items(
                            count = 20,
                            key = { index ->
                                "PfadijahrePhotoLoadingCell$index"
                            }
                        ) { _ ->

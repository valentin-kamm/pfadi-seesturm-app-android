...
class GroupedColumnSectionScope(
    ...
    fun textItems(
        ...
        supportingContent: @Composable (() -> Unit)? = null,
        leadingContent: GroupedColumnItemLeadingContentType = GroupedColumnItemLeadingContentType.None,
        trailingContent: (index: Int) -> GroupedColumnItemTrailingContentType = { GroupedColumnItemTrailingContentType.None },
        textColor: (@Composable () -> Color)? = null,
        tonalElevation: Dp = ListItemDefaults.Elevation,
        shadowElevation: Dp = ListItemDefaults.Elevation,
        onClick: ((index: Int) -> Unit)? = null,
        ...
        repeat(count) { index ->
            items += internalItem(
                ...
                supportingContent = supportingContent,
                leadingContent = leadingContent,
                trailingContent = trailingContent(index),
                textColor = textColor,
                tonalElevation = tonalElevation,
                shadowElevation = shadowElevation,
                onClick = onClick?.let { { it(index) } },
    ...
    fun <T> textItems(
        ...
        supportingContent: @Composable (() -> Unit)? = null,
        leadingContent: GroupedColumnItemLeadingContentType = GroupedColumnItemLeadingContentType.None,
        trailingContent: (item: T) -> GroupedColumnItemTrailingContentType = { GroupedColumnItemTrailingContentType.None },
        textColor: (@Composable () -> Color)? = null,
        tonalElevation: Dp = ListItemDefaults.Elevation,
        shadowElevation: Dp = ListItemDefaults.Elevation,
        onClick: ((item: T) -> Unit)? = null,
        ...
        items.forEach { i ->
            this.items += internalItem(
                ...
                supportingContent = supportingContent,
                leadingContent = leadingContent,
                trailingContent = trailingContent(i),
                textColor = textColor,
                tonalElevation = tonalElevation,
                shadowElevation = shadowElevation,
                onClick = onClick?.let { { it(i) } },
    ...
    fun <T> textItemsIndexed(
        ...
        supportingContent: @Composable (() -> Unit)? = null,
        leadingContent: GroupedColumnItemLeadingContentType = GroupedColumnItemLeadingContentType.None,
        trailingContent: (index: Int, item: T) -> GroupedColumnItemTrailingContentType = { _, _ -> GroupedColumnItemTrailingContentType.None },
        textColor: (@Composable () -> Color)? = null,
        tonalElevation: Dp = ListItemDefaults.Elevation,
        shadowElevation: Dp = ListItemDefaults.Elevation,
        onClick: ((index: Int, item: T) -> Unit)? = null,
        ...
        items.forEachIndexed { index, i ->
            this.items += internalItem(
                ...
                supportingContent = supportingContent,
                leadingContent = leadingContent,
                trailingContent = trailingContent(index, i),
                textColor = textColor,
                tonalElevation = tonalElevation,
                shadowElevation = shadowElevation,
                onClick = onClick?.let { { it(index, i) } },

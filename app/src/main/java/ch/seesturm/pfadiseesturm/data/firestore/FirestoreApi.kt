...
interface FirestoreApi {
    ...
    suspend fun <T: FirestoreDto>observeDocument(document: DocumentReference, type: Class<T>): Flow<SeesturmResult<T, DataError.RemoteDatabase>>
    ...
    suspend fun <T: FirestoreDto>performTransaction(document: DocumentReference, type: Class<T>, update: (T) -> T)
}
...
class FirestoreApiImpl(
    ...
    override fun <T : FirestoreDto> observeCollection(
        ...
        val listener = query.addSnapshotListener { snapshot, error ->
            if (error != null) {
                trySend(SeesturmResult.Error(DataError.RemoteDatabase.READING_ERROR(

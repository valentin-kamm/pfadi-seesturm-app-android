...
import ch.seesturm.pfadiseesturm.util.getWeatherConditionByCode
...
fun WeatherDto.toWeather(): Weather {
    return Weather(
        ...
        readTimeFormatted = DateTimeUtil.shared.formatDate(
            date = DateTimeUtil.shared.parseIsoDateWithOffset(dateString = readTime).atZone(ZoneId.systemDefault()),
...
fun DailyWeatherDto.toDailyWeather(): DailyWeather {
    ...
    return DailyWeather(
        ...
        weatherCondition = conditionCode.getWeatherConditionByCode(conditionCode),
